  ...
  return (
   ...
   <div className='showcase'>
     <div className='overlay px-5'>
       <h1
       className='text-4xl capitalize font-bold text-white text-center mb-4'
       >Viewing Articles about {term}</h1>
